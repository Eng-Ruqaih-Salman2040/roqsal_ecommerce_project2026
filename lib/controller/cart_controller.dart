    ...
    if (StatusRequest.success == statusRequest) {
      if (response['status'] == "success") {
        if (response['datacart']['status'] == 'success') {
          ...
          // Assign totalcountitems safely
          if (dataresponsecountprice['totalcount'] is int) {
            totalcountitems = dataresponsecountprice['totalcount'];
          } else if (dataresponsecountprice['totalcount'] is String) {
            totalcountitems = int.parse(dataresponsecountprice['totalcount']);
          }

          // Assign priceorders safely
          if (dataresponsecountprice['totalprice'] is double) {
            priceorders = dataresponsecountprice['totalprice'];
          } else if (dataresponsecountprice['totalprice'] is String) {
            priceorders = double.parse(dataresponsecountprice['totalprice']);
          } else if (dataresponsecountprice['totalprice'] is int) {
            // Convert int to double
            priceorders = (dataresponsecountprice['totalprice'] as int).toDouble();
          }
